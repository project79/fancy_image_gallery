...
Or use <code>fancy_list</code> function. For slider funcionality use <code>fancy_slider</code> with additional arguments.
...
h4. Version 0.9.4 (June 2013)

* en-message corrected

h4. Version 0.9.3 (June 2013)

* English, German and Croatian translations corrected and updated

h4. Version 0.9.2 (May 2013)

* New function <code>fancy_slider</code>

h4. Version 0.9.1 (April 2013)
